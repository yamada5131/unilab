...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/yamada/Dev/gra/unilab/public/storage' => 'string',
            ...
            'queue.connections.rabbitmq.hosts.0.port' => 'string',
...
'filesystems.links./home/yamada/Dev/gra/unilab/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'queue.connections.rabbitmq.hosts.0.port','queue.connections.rabbitmq.hosts.0.user','queue.connections.rabbitmq.hosts.0.password','queue.connections.rabbitmq.hosts.0.vhost','queue.connections.rabbitmq.options.queue.exchange',
'queue.connections.rabbitmq.options.queue.exchange_type','queue.connections.rabbitmq.worker','queue.batching.database','queue.batching.table','queue.failed.driver',
...
'profile.edit','profile.update','profile.destroy','rooms.index','rooms.store',
'rooms.show','rooms.update','rooms.destroy','computers.store','computers.update',
'computers.destroy','computers.command','commands.store','machines.index','register','login','password.request','password.email',
...
'LOG_LEVEL','DB_CONNECTION','DB_URL','RABBITMQ_HOST','RABBITMQ_PORT',
'RABBITMQ_USER','RABBITMQ_PASSWORD','RABBITMQ_VHOST','SESSION_DRIVER','SESSION_LIFETIME',
